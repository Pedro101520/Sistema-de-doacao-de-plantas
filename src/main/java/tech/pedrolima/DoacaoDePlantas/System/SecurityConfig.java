    ...
    public SecurityFilterChain securityFilterChain (HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST,"/recuperarSenha/informarEmail").permitAll()
                        .requestMatchers(HttpMethod.POST,"/recuperarSenha/informarEmail/atualizarSenha").permitAll()
